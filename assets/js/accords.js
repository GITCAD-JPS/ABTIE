...
const PAR_CEPAGE = {
  ...
  barbera: profil('vif et fruité, acidité franche et tanins discrets', '16-18 °C',
    { pates: 3, pizza: 3, charcuterie: 3, viandeRouge: 2, volaille: 2, fromageDoux: 2, vegetarien: 2 }),
  ...
  sangiovese: profil('cerise et herbes, acidité vive', '16-18 °C',
    { pates: 3, pizza: 3, viandeRouge: 3, charcuterie: 2, volaille: 2 }),
  ...
  'pinot noir': profil('délicat, petits fruits rouges', '14-16 °C',
    { volaille: 3, viandeBlanche: 3, poisson: 2, fromageDoux: 3, vegetarien: 2, charcuterie: 2 }),
  ...
  chardonnay: profil('ample, fruits blancs et beurre', '10-12 °C',
    { poisson: 3, fruitsDeMer: 3, volaille: 3, viandeBlanche: 2, fromageDoux: 2, aperitif: 2 }),
  chasselas: profil('léger et floral, très désaltérant', '9-11 °C',
    { aperitif: 3, raclette: 3, poisson: 2, fromageDoux: 2, vegetarien: 2 }),
  'sauvignon blanc': profil('vif, agrumes et buis', '8-10 °C',
    { aperitif: 3, fruitsDeMer: 3, poisson: 3, vegetarien: 3, fromageDoux: 2 }),
  pecorino: profil('sapide et salin, belle tension', '10-12 °C',
    { poisson: 3, fruitsDeMer: 3, pates: 2, vegetarien: 2, aperitif: 2 }),
  grillo: profil('sec et méditerranéen, amande', '9-11 °C',
    { poisson: 3, fruitsDeMer: 2, epice: 3, volaille: 2, vegetarien: 2 }),
  greco: profil('corsé pour un blanc, fruits jaunes', '10-12 °C',
    { poisson: 3, fruitsDeMer: 2, volaille: 2, pates: 2 }),
  arneis: profil('floral et poire, rondeur', '10-12 °C',
    { aperitif: 3, poisson: 2, volaille: 2, vegetarien: 2 }),
  'pinot gris': profil('riche et épicé, parfois demi-sec', '10-12 °C',
    { epice: 3, volaille: 2, fromageFort: 2, dessert: 2, aperitif: 2 }),
  gewurztraminer: profil('exubérant, litchi et rose', '10-12 °C',
    { epice: 3, fromageFort: 3, dessert: 2, aperitif: 2 }),
  marsanne: profil('gras et miellé, faible acidité', '11-13 °C',
    { poisson: 2, volaille: 3, fromageFort: 2, viandeBlanche: 2 }),
  ...
  heida: profil('altier et salin, notes d’agrumes', '10-12 °C',
    { aperitif: 3, poisson: 2, raclette: 2, fromageDoux: 2 }),
  viognier: profil('abricot et fleurs blanches, onctueux', '10-12 °C',
    { epice: 3, volaille: 2, poisson: 2, dessert: 1 }),
  malvasia: profil('aromatique et souple', '9-11 °C',
    { aperitif: 3, vegetarien: 2, poisson: 2, dessert: 1 }),
  'ribolla gialla': profil('tendu et minéral', '9-11 °C',
    { aperitif: 2, fruitsDeMer: 3, poisson: 3, vegetarien: 2 }),
  ...
  glera: profil('bulles fines, poire et fleurs', '6-8 °C',
    { aperitif: 3, fruitsDeMer: 2, poisson: 2, dessert: 1 }),
};
...
const PAR_APPELLATION = {
  ...
  valpolicella: profil('fruits rouges et fraîcheur', '15-17 °C',
    { pates: 3, pizza: 3, charcuterie: 2, volaille: 2 }),
  ...
  chianti: profil('cerise et herbes, gouleyant', '16-17 °C',
    { pates: 3, pizza: 3, viandeRouge: 2, charcuterie: 2 }),
...
const PAR_COULEUR = {
  ...
  rose: profil('rosé, à servir bien frais', '10-12 °C',
    { aperitif: 3, charcuterie: 2, vegetarien: 2, pizza: 2, epice: 2 }),
...
const PLUS_PRECIS = { fromageDoux: ['fromageFort'] };
